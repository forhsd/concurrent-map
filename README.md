...
```go
import (
	"github.com/forhsd/concurrent-map/v2"
)

```

```bash
go get "github.com/forhsd/concurrent-map/v2"
```
...
```bash
go test "github.com/forhsd/concurrent-map/v2"
```
...
MIT (see [LICENSE](https://github.com/forhsd/concurrent-map/blob/master/LICENSE) file)
